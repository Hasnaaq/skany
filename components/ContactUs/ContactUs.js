...
export default function ContactUs() {
  return (
    <div>
        ...
        backgroundImage="/images/ContactUs/image (5).svg"
        />
...
We'd love to hear from you! Please fill out the form below and we'll get in touch with you shortly.                    </p>
        ...
        title="Find us in Google maps"
        description="We'd love to hear from you! Please fill out the form below and we'll get in touch with you shortly."
          />
          <Footer/>
