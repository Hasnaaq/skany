...
//   {
//     sender: "me",
//     content: "I need some help with the water pipes.",
//     time: "10:43 AM",
//     type: "text",
//   },
//   {
//     sender: "them",
//     content: "Sure! Can you send me a photo?",
//     time: "10:44 AM",
//     type: "text",
//   },
//   {
...
//       {/* Left Panel */}
//       <aside className="w-1/3 max-w-sm bg-white border-r overflow-y-auto">
//         <div className="p-4 font-semibold text-xl border-b">Chat</div>
//         <div className="p-2">
//           <input
//             type="text"
//             placeholder="Search"
...
//                   <p className="text-xs text-gray-500 truncate w-40">A short preview of the message...</p>
//                 </div>
//               </li>
//             ))}
//         </ul>
...
//             <div>
//               <h2 className="font-semibold text-sm">Saad Ahmed</h2>
...
//                 {msg.sender !== "me" && (
//                   <img src="/images/user1.jpg" className="w-8 h-8 rounded-full" alt="sender" />
//                 )}
//                 <div
//                   className={`px-4 py-2 rounded-lg text-sm ${
//                     msg.sender === "me"
//                       ? "bg-teal-800  text-gray-900 rounded-br-none"
